          ...
          <div className="bg-slate-200 rounded-[50px] px-8 lg:px-12 py-16 lg:py-20 relative overflow-hidden">
            ...
            <div className="absolute left-4 bottom-32">
              <div className="space-y-4">
                <div className="w-14 h-px bg-brand/70" />
                <div className="w-10 h-px bg-brand/70" />
                <div className="w-9 h-px bg-brand/70" />
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 relative z-10">
              ...
              <div className="bg-white rounded-lg shadow-xl p-8">
                <div className="flex items-start space-x-6">
                  <div className="relative flex-shrink-0">
                    <div className="w-16 h-16 rounded-full border-2 border-brand overflow-hidden">
                      <img 
                  ...
                  <div className="flex-1">
                    <div className="flex items-center justify-between mb-2">
                      <h4 className="text-gray-800 font-bold text-xl lg:text-2xl">Sarah Miller</h4>
              ...
              <div className="bg-white rounded-lg shadow-xl p-8">
                <div className="flex items-start space-x-6">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center justify-between mb-2">
                      <h4 className="text-gray-800 font-bold text-xl lg:text-2xl">Elizabeth Thomp</h4>
                      <div className="flex space-x-1">
                        {[...Array(5)].map((_, i) => (
                          <svg key={i} className="w-5 h-5 text-brand" fill="currentColor" viewBox="0 0 24 24">
                            <path d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z"/>
              ...
              <div className="bg-white rounded-lg shadow-xl p-8">
                <div className="flex items-start space-x-6">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center justify-between mb-2">
                      <h4 className="text-gray-800 font-bold text-xl lg:text-2xl">Moe John</h4>
                      <div className="flex space-x-1">
                        {[...Array(3)].map((_, i) => (
                          <svg key={i} className="w-5 h-5 text-brand" fill="currentColor" viewBox="0 0 24 24">
                            <path d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z"/>
              ...
              <div className="bg-white rounded-lg shadow-xl p-8">
                <div className="flex items-start space-x-6">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center justify-between mb-2">
                      <h4 className="text-gray-800 font-bold text-xl lg:text-2xl">Abdul Khan</h4>
                      <div className="flex space-x-1">
                        {[...Array(4)].map((_, i) => (
                          <svg key={i} className="w-5 h-5 text-brand" fill="currentColor" viewBox="0 0 24 24">
                            <path d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z"/>
