    ...
    <section className="relative py-16 lg:py-24 px-4 lg:px-28 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-16 lg:mb-20">
            <h2 className="text-3xl sm:text-4xl lg:text-6xl font-bold leading-tight mb-8 lg:mb-0 max-w-3xl">
            ...
            <div className="bg-white rounded-3xl shadow-lg overflow-hidden relative">
              <div className="relative">
                <img 
                  ...
                  alt="Major Library" 
                  className="w-full h-72 lg:h-80 object-center rounded-2xl m-5"
                />
                {/* Good Badge */}
